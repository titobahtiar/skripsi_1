										...
										<table class="table table-striped table-small tblbarang">
											...
											<tbody>
												<?php if ($data->id_pengiriman != "" && $data->barang != null) : ?>
													<?php
													$barang = $this->pengiriman_model->get_barang_by_id_pengiriman($data->id_pengiriman);
													?>

													<?php foreach ($barang as $br) : ?>
														<tr>
															<td><input type='hidden' name='detail[id_barang][]' value="<?php echo $br['id_barang']; ?>"><?php echo $br['id_barang']; ?></td>
															<td><?php echo $br['nama']; ?></td>
															<td><?php echo $br['kategori']; ?></td>
															<td><?php echo $br['satuan']; ?></td>
															<td><input type='text' class="form-control" name='detail[qty][<?php echo $br['id_barang']; ?>]' value='<?php echo $br['qty']; ?>' size='5'></td>
