...
<body class="hold-transition skin-blue layout-boxed sidebar-mini">
  <div class="wrapper">
    <header class="main-header">
      <!-- Logo -->
      <a href="" class="logo">
        <span class="logo-mini"><b>HK</b></span>
        <span class="logo-lg"><b>PERSEDIAAN</b></span>
      </a>
        ...
        <ul class="sidebar-menu">
          ...
          <?php if ($CI->getStatus() == '1') : ?>
            <li>
              <a href="<?php echo site_url('barang') ?>">
                <i class="fa fa-file-text"></i> <span>Barang</span> <i class="fa pull-right"></i>
              </a>
            </li>
          <?php endif; ?>
          ...
          <?php if ($CI->getStatus() == '2' || $CI->getStatus() == '1') : ?>
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo site_url('barang/rekapbarang') ?>"><i class="fa fa-circle-o"></i> Laporan Persediaan</a></li>
              </ul>
              <ul class="treeview-menu">
